...
import { directorMarkup } from "../director.js"

const generateProductsMarkup = async (type_product) => {
    const products_by_type = await requestGetApi(`/product/get_product_by_type/${type_product}`, 'get')
    const itemsMarkup = [[]]
