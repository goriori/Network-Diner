...
// Генерация callback поинтов

import roles_markups from './settings/markups/roles.js'
import { directorMarkup, stafMarkup, roomMarkups, menuMarkup, productsMarkup } from './settings/markups/director/director.js'
...
console.log(menuMarkup.inline_keyboard.flat(Infinity))
